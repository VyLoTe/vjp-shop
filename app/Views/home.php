			...
			<div id="homeCarousel" class="carousel slide w-100 h-100" data-bs-ride="carousel" data-bs-interval="500">
				...
				<div class="carousel-inner w-100 h-100">
					<div class="carousel-item active w-100 h-100">
						<img src="public/images/g1.jpg" class="d-block w-100 h-100 img-cover" alt="...">
					</div>
					...
					<div class="carousel-item w-100 h-100">
						<img src="public/images/g13.jpg" class="d-block w-100 h-100 img-cover" alt="...">
					</div>
					<div class="carousel-item w-100 h-100">
				...
				<button class="carousel-control-prev custom-btn" type="button" data-bs-target="#homeCarousel" data-bs-slide="prev">
					<span class="carousel-control-prev-icon"></span>
				</button>
				<button class="carousel-control-next custom-btn" type="button" data-bs-target="#homeCarousel" data-bs-slide="next">
					<span class="carousel-control-next-icon"></span>
				</button>
			</div>
		</div>
		<div class="static-banner d-flex flex-column" style="flex: 1 1 0; height: 100%; gap: 5px;">
			<div style="height: calc(50% - 2.5px);">
				<img src="public/images/sp1.jpeg" alt="" style="width: 100%; height: 100%; display: block; margin-top: 0;">
			</div>
			<div style="height: calc(50% - 2.5px);">
				<img src="public/images/sp2.jpeg" alt="" style="width: 100%; height: 100%; display: block; margin-bottom: 0;">
			</div>
		</div>
	</div>
</div>