			...
			<div class="d-flex justify-content-center align-items-center" style="height: 270px; overflow: hidden;">
				<div id="homeCarousel" class="carousel slide w-100 h-100" data-bs-ride="carousel">
					...
					<div class="carousel-inner w-100 h-100">
						...
						<div class="carousel-item active w-100 h-100">
							<img src="public/images/g9.jpg" class="d-block w-100 h-100 img-cover" alt="...">
						</div>
						<div class="carousel-item w-100 h-100">
						...
						<div class="carousel-item w-100 h-100">
							<img src="public/images/g16.jpg" class="d-block w-100 h-100 img-cover" alt="...">
						</div>
					</div>
				...
				<div class="static-banner d-flex flex-column flex-grow-1 flex-shrink-1">
					<div>
						<img src="" alt="">
					</div>
					<div>
